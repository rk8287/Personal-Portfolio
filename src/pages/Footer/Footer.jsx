    ...
    <div className='main-footer-container'>
      <div className="main-footer-section">
        <div className="footer-name">
            <div className='logo-name'><span style={{color:'#e6fc56',fontWeight:'900',fontFamily:'cursive'}}>R</span>aunak</div>
        </div>
        ...
        <div className="footer-other-content">
            ...
            <div className="footer-semi">
              ...
              <div className="footer-det">
                <Link className='footer-mail'>Gurugram, Haryana</Link>
                <div className='footer-mail'>Sector 5</div>
